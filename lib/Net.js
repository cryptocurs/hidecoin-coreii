...
class Net extends Component {
  ...
  broadcastTxInfoZipped(hash, data) {
    const txInfoZipped = TxInfoZipped.create({hash, data})
    txInfoZipped.getRaw((raw) => this.broadcast(raw))
  }
